...
export const createTodoRouter = (io: Server) => {
  const router = Router();
  ...
  router.post("/", validateTodo, async (req, res, next) => {
    try {
      ...
      io.to("workspace:default").emit("todo:created", todo);
  ...
  router.put("/:id", validateTodoUpdate, async (req, res, next) => {
    try {
      ...
      io.to("workspace:default").emit("todo:updated", todo);
  ...
  router.delete("/:id", async (req, res, next) => {
    try {
      ...
      io.to("workspace:default").emit("todo:deleted", {
        id,
      });
